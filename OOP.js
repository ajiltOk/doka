...
То есть разные объекты могут реагировать на один и тот же запрос, проявляя разное поведение в зависимости от своего типа.
Полиморфизм бывает:
...
//Перегрузка функции (ts) - параметрический полиморфизм функции при реализауии.
...
//В ООП между объектами есть связи. Эти связи создаются с помощью ассоциаций. Ассоциации - это включение внутрь одного объекта ссылки на другой объект для его дальнейшего использования.
//Ассоциация бывает двух типов: с помощью композиции и агрегации.
//Композиция - это когда ссылка существует только внутри объекта, агрегация - когда и вне объекта , от этого зависит поведение зависимости при удалении объекта-контейнера.
//В композиции время жизни зависимости ограничено временем жизнью объекта-родителя. В агрегации зависимость может существовать и при удалении родителя
