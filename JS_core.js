...
с использованием ключевых слов let и const. В TDZ переменная существует, но не может быть доступна или прочитанадо тех пор, пока не будет выполнено объявление.
